...
class MyPytorchModel(nn.Module):
    ...
    def __init__(self, hparams):
        ...
        #""" This model is 48% accuracy in validation (3805 params)
    ...
    def configure_optimizers(self):
        ...
        #optimizer = optim.SGD(net.parameters(), self.hparams['learning_rate'], momentum=0.9)
        ...
        #optimizer = torch.optim.ASGD(self.parameters(), lr=self.hparams['learning_rate'])
        #optimizer = torch.optim.LBFGS(self.parameters(), lr=self.hparams['learning_rate'])
...
class CIFAR10DataModule(nn.Module):
    ...
    def prepare_data(self, stage=None, CIFAR_ROOT="../datasets/cifar10"):
        ...
        if self.opt['loading_method'] == 'Image':
            ...
            cifar_complete_augmented = torchvision.datasets.CIFAR10(root=CIFAR_ROOT, train=True, download=True, transform=my_transform)
            cifar_complete_train_val = torchvision.datasets.CIFAR10(root=CIFAR_ROOT, train=True, download=True, transform=train_val_transform)
